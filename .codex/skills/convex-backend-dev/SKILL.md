...
description: Use when working with Convex backend code including queries, mutations, actions, schema design, indexing, or database performance. Do not use for frontend-only React/UI work.
---
